...
@WebServlet(name="RequestPasswordServlet", urlPatterns={"/request_password"})
public class RequestPasswordServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Viewer viewer = daoUser.getViewerByEmail(email);
        if(viewer == null) {
        ...
        String linkReset = request.getScheme() + "://" + request.getServerName()
        + ":" + request.getServerPort()
        + request.getContextPath() + "/reset_password?token=" + token;
        
        ForgetPasswordToken newTokenForget = new ForgetPasswordToken(viewer.getUser_id(), false, token, service.expireDateTime());
        ...
        boolean isSend = service.sendEmail(email, linkReset, viewer.getUsername());
        if(!isSend) {
